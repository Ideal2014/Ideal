                ...
                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                    <div class="breadcrumbs pull-right">
                        <ul>
                            ...
                            <li>
                                <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="#">购买次卡</asp:HyperLink></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="p_table">
                        ...
                        <div class="column_1">
                            <ul>
                                ...
                                <!-- column footer -->
                                <li class="footer_row">
                                    <asp:Button ID="button1" Text="购买" class="sign_up btn-color btn-small" runat="server" NavigateUrl="#" OnClick="button1_Click" /></li>
                            </ul>
                        </div>
                        <!-- column style 2 -->
                        <div class="column_2">
                            <ul>
                                ...
                                <!-- column footer -->
                                <li class="footer_row">
                                    <asp:Button ID="button2" Text="购买" class="sign_up btn-color btn-small" runat="server" NavigateUrl="#" OnClick="button2_Click" /></li>
                            </ul>
                        </div>
                        <!-- column style 3 -->
                        <div class="column_3">
                            <ul>
                                ...
                                <!-- column footer -->
                                <li class="footer_row">
                                    <asp:Button ID="button3" Text="购买" class="sign_up btn-color btn-small" runat="server" NavigateUrl="#" OnClick="button3_Click" /></li>
                            </ul>
                        </div>
                        <!-- column style 4 -->
                        <div class="column_4">
...
<asp:Content ID="Content3" ContentPlaceHolderID="js" runat="Server">
    <script type="text/javascript">
        document.getElementById("body").className = "page";
