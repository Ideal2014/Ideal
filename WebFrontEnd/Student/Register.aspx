                        ...
                        <div class="row">
                          <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 ">
                            用户名：  <asp:TextBox id="Name" class="form-control" placeholder="只能输入6-20个以字母开头、可带数字、“_”、“.”的字串"  runat="server" />
                              <asp:RequiredFieldValidator ID="NameValidator1" runat="server" ValidationGroup="registe"
                                  ErrorMessage ="用户名不能为空" ControlToValidate="Name" Display="Dynamic"
                                  Font-Size="15px" ForeColor="Red"></asp:RequiredFieldValidator>
                              <asp:RegularExpressionValidator ID="NameValidator2" runat="server" ValidationGroup="registe"
                              ...
                              <asp:CustomValidator runat="server" ID="NameValidator3" DisPlay="Dynamic" 
                               OnServerValidate="RegisterValidate_ServerValidate" ValidationGroup="registe"
                            ...
                            <br />密码：  <asp:TextBox ID="Password1" TextMode="password" class="form-control" placeholder="输入6-20位密码" runat="server" />
                              <asp:RequiredFieldValidator ID="Password1Validator1" runat="server" ValidationGroup="registe"
                              ...
                              <asp:RegularExpressionValidator ID="Password1Validator2"  runat="server"  ControlToValidate="Password1"
                                  ErrorMessage="密码6-20位" ValidationGroup="registe"
                            ...
                            <br />确认密码：  <asp:TextBox ID="Password2" TextMode="password" class="form-control" placeholder="请再次输入密码" runat="server" />
                              <asp:RequiredFieldValidator ID="Password2Validator1" runat="server" ValidationGroup="registe"
                                  ControlToValidate="Password2" Display="Dynamic" ErrorMessage="不能为空"
                                  Font-Size="15px" ForeColor="Red"></asp:RequiredFieldValidator>
                              <asp:CompareValidator ID="Password2Validator2" runat="server" ValidationGroup="registe"
                           ...
                           <br /> 用户邮箱：  <asp:TextBox id="MailBox" class="form-control" placeholder="请输入有效邮箱" runat="server" />
                              <asp:RequiredFieldValidator ID="MailValidator1" runat="server" ValidationGroup="registe"
                                  ControlToValidate="MailBox" Display="Dynamic" ErrorMessage="不能为空"
                                  Font-Size="15px" ForeColor="Red"></asp:RequiredFieldValidator>
                              <asp:RegularExpressionValidator ID="MailValidator2" runat="server" ValidationGroup="registe"
                                   ControlToValidate="MailBox" Display="Dynamic" ErrorMessage="邮箱格式不正确"
                                   ValidationExpression="^[\w-]+(\.[\w-]+)*@[\w-]+(\.[\w-]+)+$"
                                    Font-Size="15px" ForeColor="Red"></asp:RegularExpressionValidator>
                              <div class="checkbox">
                                  <asp:Button id="Register" Text="注册" ValidationGroup="registe" class="btn-color btn-normal btn-pad" runat="server" OnClick="Register_Click" />
                              </div>
                        </div>
                     </div>
