                  ...
                  <div class="row" >
                     <div class="col-lg-12 col-md-12">
                        <h3 class="title">用户登录</h3>
                         <div >
                          <asp:CustomValidator runat="server" ID="LoginValidate" DisPlay="Dynamic"  OnServerValidate="LoginValidate_ServerValidate"
                        ...
                        <div class="row">
                          <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 ">
                           <br /> 账号：  
                              ...
                              <asp:RegularExpressionValidator ID="NameValidator2" runat="server"
                                  ErrorMessage="格式不对，请输入只能输入6-20个以字母开头、可带数字、“_”、“.”的字串" ControlToValidate="Username"
                          ...
                          <br /> <asp:Button id="Login" Text="登录" class="btn-color btn-normal btn-pad" runat="server" OnClick="Login_Click" />
                            <!-- /input-group -->
