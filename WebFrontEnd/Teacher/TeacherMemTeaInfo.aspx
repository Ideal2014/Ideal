                            ...
                            <div class="post-content">
                                <div>
                                    <asp:Image ID="ImageT" Style="float: left" runat="server" /><ul style="float: left">
                                        <li>
                                            <h2>
                                                <asp:Label ID="LabelName" runat="server" /></h2>
                                        </li>
                                        <li>
                                            <asp:Label ID="LabelSkill" runat="server" /></li>
                                        <li>
                                            <asp:Label ID="LabelNation" runat="server" /></li>
                                    </ul>
                                    <asp:Label ID="LabelID" runat="server" Visible="false" />
                                    <asp:Button ID="BuyButton" CssClass="btn-color btn-normal btn-pad" Style="float: right" runat="server" Text="购买" OnClick="BuyButton_Click"></asp:Button><div class="clearfix"></div>
                                    <div class="divider" />
                                </div>
                                <p>
                                    <asp:Label ID="LabelDes" runat="server" /></p>
                            </div>
                        </article>
                    </div>
                    <!-- Left Section End -->
