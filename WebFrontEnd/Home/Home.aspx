            ...
            <ul>
                ...
                <li data-transition="fade" data-slotamount="1" data-masterspeed="300">
                    ...
                    <div class="caption lfl"
                        ...
                        data-start="1400"
                        data-easing="easeOutExpo">
                        <asp:Image ID="Image3" runat="server" Height="186" Width="400" />
                    </div>
                    <div class="caption lfl"
                        data-x="323"
                        data-y="145"
                        ...
                        data-start="1500"
                        data-easing="easeOutExpo">
                        <asp:Image ID="Image4" runat="server" Height="163" Width="110" />
                    </div>
                </li>
            </ul>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="content-box big ch-item">
                        ...
                        <div class="content-box-info">
                            <h3>媒体报道</h3>
                            <h5>2015年，Viki Chat 成功上市，让我们来共同探究其成功的秘密。
                            </h5>
                            <p>
                                        ...
                                        <div class="carousel-inner">
                                            <div class="item active">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="testimonial item">
                                                        <p>
                                                            <a href="celebrity_detail.html" target="_blank">雅思成绩：总分8分，听力9分，阅读8分，口语7.5分<br>
                                                        ...
                                                        <div class="author">
                                                            <div class="testimonial-image ">
                                                                <img alt="" src="../img/celebrity/teamm1.jpg" />
                                                            </div>
                                            ...
                                            <div class="item">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="testimonial item">
                                                        <p>
                                                            <a href="celebrity_detail.html" target="_blank">雅思成绩：听力9分，口语7分<br>
                                                        ...
                                                        <div class="author">
                                                            <div class="testimonial-image ">
                                                                <img alt="" src="../img/celebrity/teamm2.jpg" />
                                                            </div>
                                                            <div class="testimonial-author-info">
                                            ...
                                            <div class="item">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="testimonial item">
                                                        <p>
                                                            <a href="celebrity_detail.html" target="_blank">托福成绩：托福105分 听力30分<br>
                                                        ...
                                                        <div class="author">
                                                            <div class="testimonial-image ">
                                                                <img alt="" src="../img/celebrity/teamm3.jpg" />
                                                            </div>
                                                            <div class="testimonial-author-info">
