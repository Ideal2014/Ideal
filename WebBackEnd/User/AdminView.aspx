<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AdminView.aspx.cs" Inherits="User_AdminView__" %>
						...
						<form class="form-horizontal">
							<fieldset>
							  <div class="control-group">
								...
								<div class="controls">
                                  <asp:TextBox runat="server" CssClass="input-xlarge focused" SkinID="focusedInput" ID="AdminNo" ReadOnly="true"></asp:TextBox>
								</div>
							  </div>
                              ...
                              <div class="control-group">
								...
								<div class="controls">
		                          <asp:TextBox runat="server"  CssClass="input-xlarge focused" SkinID="focusedInput" ID="AdminPetname" ReadOnly="true"></asp:TextBox>
								</div>
							  </div>
							  <div class="form-actions">
								  <asp:Button runat="server" CssClass="btn btn-primary" ID="Reset" Text="返回" OnClick="Reset_Click"/>
							  </div>
							</fieldset>
						  </form>
